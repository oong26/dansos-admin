                ...
                <div class="card-body">
                    <form action="{{ route('masyarakat.store') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nik') is-invalid @enderror" name="nik" id="basic-default-nik" placeholder="35111xxxxxxxxxxx" required/>
                            @error('nik')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="nama" id="basic-default-fullname" placeholder="John Doe" required/>
                            @error('name')
                            <div class="form-text text-danger">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" name="tanggal_lahir" id="basic-default-tgllahir" required/>
                            @error('tanggal_lahir')
                            <div class="form-text text-danger">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('no_hp') is-invalid @enderror" type="tel" max="13" placeholder="08xxxxxxxxxx" name="no_hp" id="html5-tel-input" required/>
                            @error('no_hp')
                            <div class="form-text text-danger">{{$message}}</div>
                            @enderror
                        </div>
