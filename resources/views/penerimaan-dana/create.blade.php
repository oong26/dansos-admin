    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('penerimaan-dana.store') }}" method="post">
                        @csrf
                        <div class="mb-3">
                            <label for="exampleFormControlSelect1" class="form-label">NIK</label>
                            <select class="form-select custom-select @error('nik') is-invalid @enderror" name="nik" id="exampleFormControlSelect1" aria-label="Default select example" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" id="basic-default-fullname" required/>
                            @error('tanggal')
                            <div class="form-text text-danger">{{$message}}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('nominal') is-invalid @enderror" type="number" placeholder="20xxxxxxxxxx" name="nominal" id="html5-tel-input" required/>
                            @error('nominal')
                            <div class="form-text text-danger">{{$message}}</div>
                            @enderror
                        </div>
